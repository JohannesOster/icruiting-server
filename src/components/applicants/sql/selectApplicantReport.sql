SELECT 
	...
	job_id,
	json_build_object('label', imageField.label, 'form_field_id', imageField.form_field_id) as image,
...
GROUP BY applicant_report.applicant_report_id, imageField.label, imageField.form_field_id
